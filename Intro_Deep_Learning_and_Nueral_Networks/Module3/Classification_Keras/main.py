...
# So need to flatten the images into one-dimensional vectors, each of size 1 x (28 x 28) = 1 x 784
...
# When you are ready to use your model again
# use the load_model() function from keras.model
